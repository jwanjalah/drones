...
<title>Drones Adverts Portal</title>
<!--Bootstrap -->
...
<!-- Banners -->
  ...
  <div class=central>
    <video id="vid1" width="400" controls>
       <source src="dn.mp4" type="video/mp4">
...
div.central { 
  margin: 0 auto;
  width: 990px; <!--this value must be larger than both videos + padding etc-->
}
</style>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Find the Best <span>Drone For You</span></h2>
      <p>The best Drones for you are located here. Your budget, needs and taget population should inform your decision of the choice you will make</p>
    </div>
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">New Drone</a></li>
        </ul>
      </div>
