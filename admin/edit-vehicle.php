...
<head>
	...
	<title>Drones Adverts  Portal | Admin Edit drone Info</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Edit Drone</h2>
...
<label class="col-sm-2 control-label">Drone Title<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">Drone Overview<span style="color:red">*</span></label>
<div class="col-sm-10">
...
<label class="col-sm-2 control-label">Select Capacity<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<label class="col-sm-2 control-label">Altitude(Metres)<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="col-md-12">
<div class="panel panel-default">
<div class="panel-heading">SUPER FEATURES</div>
<div class="panel-body">
...
<label for="inlineCheckbox2"> LED Indicators </label>
</div>
<?php } else {?>
...
<label for="inlineCheckbox3"> Propulsion Power </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> GPRS </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox1"> Remote Control </label>
</div>
<?php } else {?>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">Accelerator</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Sensor </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Power Wings </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">Central Lock</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-success checkbox-inline">
