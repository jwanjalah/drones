...
if(isset($_POST['submit']))
  {
$Dronetitle=$_POST['Dronetitle'];
$brand=$_POST['brandname'];
$Droneoverview=$_POST['Droneoverview'];
...
<head>
	...
	<title>DRONE ADVERT Portal | Admin Post DRONE</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Post A Drone</h2>
...
<label class="col-sm-2 control-label">DRONE
