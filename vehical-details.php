...
if($lastInsertId)
{
echo "<script>alert('Scheduled successfull.');</script>";
}
else 
{
...
<title>Drone Rental Port | Drone Details</title>
<!--Bootstrap -->
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap"> 
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" data-toggle="tab">Drone Overview </a></li>
          
              <li role="presentation"><a href="#accessories" aria-controls="accessories" role="tab" data-toggle="tab">SUPER FEATURES</a></li>
            </ul>
            ...
            <div class="tab-content"> 
              ...
              <div role="tabpanel" class="tab-pane" id="accessories"> 
                ...
                <table>
                  <thead>
                    <tr>
                      <th colspan="2">Super Features</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-envelope" aria-hidden="true"></i>Schedule Now</h5>
          </div>
          <form method="post">
          ...
          <?php if($_SESSION['login'])
              ...
              <?php } else { ?>
<a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Login For Scheduling</a>
        ...
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
             ...
             <li><i class="fa fa-user" aria-hidden="true"></i><?php echo htmlentities($result->SeatingCapacity);?>Metres</li>
